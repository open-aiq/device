...
extern const uint8_t backendRootCAStart[] asm("_binary_include_certs_backend_root_ca_pem_start");
...
UploadResult uploadReading(const SensorReadings &r)
{
  ...
  client.setCACert(reinterpret_cast<const char *>(backendRootCAStart));
